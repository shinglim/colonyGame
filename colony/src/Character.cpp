...
Character::Character(int gridX, int gridY, SDL_Color c)
    : gx(gridX), gy(gridY), targetX(gridX), targetY(gridY),
...
void Character::render(SDL_Renderer* renderer, int cellSize) {
